...
public class TextScan {
    ...
    // taken from TextScan.java
    public static void textScan(String file, Hashtable hashy){

        Scanner readFile = null;
        String s;

        //ensures file is valid and exists
        System.out.println();
        ...
        // goes through every word/token until end of file is reached
    ...
    public static void main(String[] args, Hashtable hashtable) {
